...
int main()
{
    ...
    insert_message( arg_map, 2, 1, std::function< void() >( task2 ), "task2" );
    insert_message( arg_map, 3, 1, std::function< void() >( task3 ), "task3" );
    insert_message( arg_map, 4, 1, std::function< void() >( task4 ), "task4" );
    insert_message( arg_map, 5, 4 );

    insert_message( arg_map, 6, 1, std::function< void() >( task5 ), "task5" );
    insert_message( arg_map, 7, 1, std::function< void() >( task1 ), "task6" );
    insert_message( arg_map, 8, 1, std::function< void() >( task2 ), "task7" );
    insert_message( arg_map, 9, 1, std::function< void() >( task3 ), "task8" );
    insert_message( arg_map, 10, 4 );

    insert_message( arg_map, 11, 3, std::function< void() >( task5 ), "task7" );

    insert_message( arg_map, 12, 4 );
