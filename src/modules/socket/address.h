 ...
 * @date 2019-06-05
 * @copyright Copyright (c) 2019年 star.yin All rights reserved (www.star.top)
 */
#ifndef ADDRESS_H__
#define ADDRESS_H__
...
public:
     ...
     * @param[in] host 域名,服务器名等.举例: www.star.top[:80] (方括号为可选内容)
...
public:
     ...
     * @param[in] address 域名,IP,服务器名等.举例: www.star.top
     * @param[in] port 端口号
